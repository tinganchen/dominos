...
from data import svhn, dataLoader
...
def main():
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        test_prec1, test_prec5 = test(args, loader_test, model_s, epoch)
        ...
        model_p = import_module('utils.preprocess').__dict__[f'{args.arch}'](args, model_s.state_dict()) # args.thres
...
def compressionInfo(epoch, flops, params, test_prec1, test_prec5, org_gflops = 0.100323840, org_params = 2.398843):
    GFLOPs = flops / 10 ** 9
    params_num = params
