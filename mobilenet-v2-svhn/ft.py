...
def main():
    ...
    # pruned model
    model = import_module('utils.preprocess').__dict__[f'{args.arch}'](args, checkpoint['state_dict_s'], args.thres)
...
def compressionInfo(flops, params, org_gflops = 0.100323840, org_params = 2.398843):
    GFLOPs = flops / 10 ** 9
    params_num = params
