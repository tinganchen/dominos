...
parser.add_argument('--job_dir', type = str, default = f'experiment/vgg/ft60_t_{T}_mask_{MASK}_sigma_{SIGMA}_lambda_{LAMBDA}_kd_{KD}_{INDEX}/', help = 'The directory where the summaries will be stored.') # 'experiments/'
...
parser.add_argument('--refine', type = str, default = f'experiment/vgg/t_{T}_mask_{MASK}_sigma_{SIGMA}_lambda_{LAMBDA}_kd_{KD}_{INDEX}/checkpoint/model_44.pt', help = 'Path to the model to be fine tuned.') # None
...
parser.add_argument('--train_batch_size', type = int, default = 200, help = 'Batch size for training.')
