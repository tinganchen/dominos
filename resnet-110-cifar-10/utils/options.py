...
## rand_0, 0, 1, 2
# 0.025, 0.027, 0.07, 0.024 ## 40PR
# 0.026, 0.04, 0.09, 0.0275 ## 50PR
# 0.03, 0.06, 0.126, 0.029 ## 60PR
# 0.05, 0.15, 0.128, 0.1 ## 70PR
# 0.2, 0.2, 0.12815, 0.159 ## 80PR
...
parser.add_argument('--teacher_file', type = str, default = 'resnet_110.th', help = 'The file the teacher model weights saved as.')
