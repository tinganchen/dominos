...
MASK = 0.3  
LAMBDA = 0.01 ## 0.01, 0.013, 0.017 sparsity
...
parser.add_argument('--job_dir', type = str, default = f'experiment/densenet/rand_t_{T}_mask_{MASK}_sigma_{SIGMA}_lambda_{LAMBDA}_kd_{KD}_{INDEX}/', help = 'The directory where the summaries will be stored.') # 'experiments/'
...
parser.add_argument('--teacher_file', type = str, default = 'densenet_40.pt.tar', help = 'The file the teacher model weights saved as.')
...
#parser.add_argument('--refine', type = str, default = f'experiment/densenet/t_{T}_mask_{MASK}_sigma_{SIGMA}_lambda_{LAMBDA}_kd_{KD}_{INDEX}/checkpoint/model_47.pt', help = 'Path to the model to be fine tuned.') # None

## Training
parser.add_argument('--arch', type = str, default = 'densenet', help = 'Architecture of teacher and student')
parser.add_argument('--target_model', type = str, default = '9-kd', help = 'The target model.')
parser.add_argument('--student_model', type = str, default = 'densenet_40_sparse', help = 'The model of student.')

parser.add_argument('--teacher_model', type = str, default = 'densenet_40', help = 'The model of teacher.')
...
parser.add_argument('--kd', type = float, default = KD, help = 'The knowledge distillation multiplier.')
